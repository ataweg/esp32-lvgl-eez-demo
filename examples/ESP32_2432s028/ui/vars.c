...
#include "F:\Projects\InternetOfThings\Devices\user_passwd.h"
#define YOUR_SSID       USER_WIFI_SSID
#define YOUR_PASSWORD   USER_WIFI_PASSWORD

char WIFI_SSID[50] = YOUR_SSID;
char WIFI_PASS[50] = YOUR_PASSWORD;
char WIFI_IP[20] = "";
